...
namespace BugTracker.Services.Interfaces
{
    public interface IBTTicketService
    {
        ...
        Task<List<Ticket>> GetProjectTicketsByStatusAsync(int companyId, string typeName);
        Task<List<Ticket>> GetProjectTicketsByPriorityAsync(int companyId, string typeName);
